...
function displayPreview(letterContent, llmEnhanced, isHtml = false, docxBase64 = null, context = null) {
  ...
  // Show/hide DOCX download button based on availability
...
enhanceBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    if (uploadedDocxBase64) {
      // New flow: fill the original .docx preserving all formatting
